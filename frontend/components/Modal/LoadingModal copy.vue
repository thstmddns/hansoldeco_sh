...
<template>
    <div class="fixed top-0 bottom-0 left-0 right-0 flex items-center justify-center w-full h-full m-auto modal_wrapper bg-black/50 z-9999">
        <div class="fixed flex flex-col items-center left-0 top-0 right-0 bottom-0 m-auto px-10 w-[496px] h-[524px] bg-[#fff] shadow shadow-[rgba(0,0,0,0.25)] flex flex-col justify-center rounded-xl relative">
            <iframe src="https://giphy.com/embed/VseXvvxwowwCc" width="480" height="480" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/VseXvvxwowwCc">via GIPHY</a></p>
